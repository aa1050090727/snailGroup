...
//            //echo $value['name'];//省
//            $pid=Db::table('f_province')->fetchSql(false)->insertGetId(['f_province_id'=>'','f_province_name'=>$value['name']]);
//            foreach($value['city'] as $key=>$val){
//                //echo $val['name'];//市
//                $cid=Db::table('f_city')->insertGetId(['f_city_id'=>'','f_city_name'=>$val['name'],'f_city_fid'=>$pid]);
//                foreach($val['area'] as $v){
//                    //echo $v;//区
//                    $aid=Db::table('f_district')->insertGetId(['f_district_id'=>'','f_district_name'=>$v,'f_district_fid'=>$cid]);
//                }
//            }
//        }
//    }
